...
class GraphEndpointTest extends BaseIntegrationTest {
    ...
    def measurement = MeasurementBuilder.create().setId('1').setDate(dateTimeNow).setHandleId('handle-1').setTemperature(1.0).setSound(10.0).build()
    def measurement2 = MeasurementBuilder.create().setId('2').setDate(dateTimeNow.minusMinutes(5)).setHandleId('handle-1').setTemperature(2.0).setSound(11.0).build()
    def measurement3 = MeasurementBuilder.create().setId('3').setDate(dateTimeNow.minusMinutes(10)).setHandleId('handle-1').setTemperature(3.0).setSound(12.0).build()
    def measurement4 = MeasurementBuilder.create().setId('4').setDate(dateTimeNow.minusMinutes(15)).setHandleId('handle-1').setTemperature(4.0).setSound(13.0).build()
    def measurement5 = MeasurementBuilder.create().setId('5').setDate(dateTimeNow.minusMinutes(20)).setHandleId('handle-1').setTemperature(5.0).setSound(14.0).build()
    ...
    def '[GET] should filter measurements by start and date end'() {
        ...
        when:
        def response = executeGet("fieldName=temperature&handleId=handle-1&startDate=$startDate&endDate=$endDate")
    ...
    def '[GET] should get data based on queried field'() {
        when:
        def response = executeGet("fieldName=$fieldName&handleId=handle-1")
